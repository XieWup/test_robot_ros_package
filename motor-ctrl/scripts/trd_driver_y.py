...
class TrdDriver():
    ...
    def __init__(self, serialprot_r, serialprot_l, baudrate):
        #self.ser = serial.Serial(serialprot, baudrate)
        self.ser_r = serial.Serial(serialprot_r, baudrate,timeout=0.5)
        self.ser_l = serial.Serial(serialprot_l, baudrate,timeout=0.5)
        ...
        self.vel_sub = rospy.Subscriber('/smooth_cmd_vel', Twist, self.vel_callback2)
    ...
    def send(self, speed_code1,speed_code2):   
        ...
        #time.sleep(0.03)
        self.ser_r.write(motor_speed_mode2)    
        self.ser_r.write(speed_code2)
        self.ser_r.write(motor_start2)
        self.ser_l.write(motor_speed_mode1)    
        self.ser_l.write(speed_code1)
        self.ser_l.write(motor_start1)
...
if __name__ =='__main__':
    ...
    m = TrdDriver('/dev/ttyS5', '/dev/ttyS4', 38400)
